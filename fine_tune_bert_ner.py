...
file_path = "HP-Dataset-Finetune-Numeric.json"
...
training_args = TrainingArguments(
    output_dir="./bert_hp_results",
    evaluation_strategy="epoch",
    save_strategy="epoch",
    logging_strategy="epoch",
    learning_rate=3e-5,  # Ridotto il learning rate
    per_device_train_batch_size=32,  # Aumentato il batch size
    per_device_eval_batch_size=32,  # Aumentato il batch size
    num_train_epochs=5,  # Aumentato il numero di epoche
    weight_decay=0.01,
    save_total_limit=2,
...
trainer.save_model("./bert_hp_trained")
tokenizer.save_pretrained("./bert_hp_trained")
print("✅ Modello addestrato e salvato!")

# 🔍 8. Test del Modello
ner_pipeline = pipeline("ner", model="./bert_ner_hp_trained", tokenizer="./bert_ner_hp_trained")
